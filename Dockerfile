...
# Copy App Code
WORKDIR ${APP_ROOT}
COPY --from=build --chown=10001:10001 --chmod=755 ${APP_ROOT}/node_modules ./node_modules
COPY --chown=10001:10001 --chmod=755 src ./src
COPY --chown=10001:10001 --chmod=755 .env.default server.ts ./
