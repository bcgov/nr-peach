locals {
  cfg_env_defaults = {
    dev = {
      ...
      app_service_scale_out_method = "Manual"
    ...
    prod = {
      ...
      app_service_scale_out_method = "Auto"
  ...
  scale_out_method     = coalesce(var.app_service_scale_out_method, local.cfg.app_service_scale_out_method)
