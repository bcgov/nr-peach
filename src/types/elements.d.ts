 ...
 * Manual edit notes:
 * - Generate and concatenate all PIES message types together
 * - Drop duplicate interface definitions such as header and asset
 * - Drop all invalid TSDoc annotations such as `@minItems` and `@maxItems`
 ...
 * identification.
 */
export type Header = Header1 & Header2;
export type Header1 = Asset;
/**
